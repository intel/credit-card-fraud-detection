...
def main(arglist):
    ...
    parser.add_argument(
        "--CSVDataset_dir",
        default="/GNN_TMP/sym_tabformer_hetero_CSVDataset/",
        help="Path to CSVDataset",
    )
    parser.add_argument(
        "--model_out",
        default="/GNN_TMP/sym_tabformer_hetero_CSVDataset/model_graphsage_2L_64.pt",
        type=str,
        help="output for model /your_path/model_graphsage_2L_64.pt",
    )
    parser.add_argument(
        "--nemb_out",
        default="/GNN_TMP/sym_tabformer_hetero_CSVDataset/node_emb.pt",
        type=str,
